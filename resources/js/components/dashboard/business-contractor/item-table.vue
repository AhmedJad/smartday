                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-left">
                      <a
                        target="__blank"
                        class="dropdown-item"
                        :href="`/uploads/${item.tax_register}`"
                        >{{ $t("tax_register") }}</a
                      >
                      ...
                      <a
                        target="__blank"
                        class="dropdown-item"
                        :href="`/uploads/${item.commercial_register}`"
                        >{{ $t("commercial_register") }}</a
                      >
...
import businessContractor from "../../../http-clients/admin/business-contractor-client";
...
الكود الخاص بكم ${data.currentItem.serial}
    ...
    function downloadExcelFile() {
      businessContractor.getAllItems().then((res) => {
        let data = res.data;
